...
def start_timer():
    ...
    if reps % 8 == 0:
        ...
        timer_label.config(text="Break", fg=RED, bg=YELLOW ,font=(FONT_NAME, 48))
    elif reps % 2 == 0:
        count_down(short_break_sec)
        timer_label.config(text="Break", fg=PINK, bg=YELLOW, font=(FONT_NAME, 48))
    else:
        count_down(work_sec)
        timer_label.config(text="Work", fg=GREEN, bg=YELLOW, font=(FONT_NAME, 48))
# ---------------------------- COUNTDOWN MECHANISM ------------------------------- #
